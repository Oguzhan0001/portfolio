    ...
    <div style={{ fontFamily: sans, color: "#F8FAFC", background: navy, minHeight: "100vh" }}>
      ...
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 24px", maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 24, fontSize: 13, color: slate, fontWeight: 500, alignItems: "center" }}>
          <a href="#" style={{ color: "inherit", textDecoration: "none" }}>Ürün</a>
          <a href="#" style={{ color: "inherit", textDecoration: "none" }}>Fiyatlar</a>
          <a href="#" style={{ color: "#F8FAFC", textDecoration: "none" }}>Giriş Yap</a>
          <button style={{ padding: "8px 18px", background: teal, color: navy, fontSize: 13, fontWeight: 700, border: "none", borderRadius: 6, cursor: "pointer" }}>Ücretsiz Başla</button>
        </div>
      </nav>

      <section style={{ maxWidth: 1000, margin: "0 auto", padding: "56px 24px 48px", textAlign: "center" }}>
        <div style={{ display: "inline-block", padding: "5px 14px", borderRadius: 20, border: "1px solid #1E3A5F", fontSize: 12, fontWeight: 500, color: teal, fontFamily: mono, marginBottom: 20 }}>Türkiye genelinde 200+ filo takip ediliyor</div>
        <h1 style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.04em", maxWidth: 700, margin: "0 auto" }}>
          Her aracın nerede olduğunu bilin. <span style={{ color: teal }}>Her zaman.</span>
        </h1>
        <p style={{ fontSize: 16, color: slate, maxWidth: 520, margin: "20px auto 32px", lineHeight: 1.65 }}>Lojistik şirketlerine gerçek zamanlı görünürlük, akıllı rotalar ve daha iyi kararlar için veri sağlayan filo yönetim yazılımı.</p>
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          <button style={{ padding: "13px 32px", background: teal, color: navy, fontSize: 14, fontWeight: 700, border: "none", borderRadius: 6, cursor: "pointer" }}>14 Gün Ücretsiz Dene</button>
          <button style={{ padding: "13px 32px", background: "transparent", color: "#F8FAFC", fontSize: 14, fontWeight: 500, border: "1px solid #334155", borderRadius: 6, cursor: "pointer" }}>Demo İzle</button>
        </div>
      </section>
          ...
          <div style={{ display: "flex", height: 280, background: "#0F172A" }}>
            ...
            <div style={{ flex: 1, padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
              <div style={{ display: "flex", gap: 10 }}>
                {[{ l: "Aktif", v: "187", c: teal }, { l: "Yolda", v: "143", c: "#3B82F6" }, { l: "Beklemede", v: "31", c: "#F59E0B" }, { l: "Çevrimdışı", v: "13", c: "#EF4444" }].map((s) => (
              ...
              <div style={{ flex: 1, borderRadius: 8, background: "#111827", border: "1px solid #1E293B", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", bottom: 8, right: 10, fontSize: 9, fontFamily: mono, color: "#475569" }}>İstanbul Metropoliten · Canlı</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ borderTop: "1px solid #1E293B", borderBottom: "1px solid #1E293B" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "40px 24px", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24, textAlign: "center" }}>
          {[{ v: "%23", l: "Yakıt tasarrufu" }, { v: "4.2M", l: "Takip edilen teslimat" }, { v: "%99.7", l: "Çalışma süresi" }, { v: "12dk", l: "Ort. yanıt süresi" }].map((s) => (
            <div key={s.l}>
      ...
      <section style={{ maxWidth: 1000, margin: "0 auto", padding: "64px 24px" }}>
        <h2 style={{ fontSize: 32, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 40 }}>Filo yönetimi için ihtiyacınız olan her şey.</h2>
      ...
      <section style={{ borderTop: "1px solid #1E293B" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "56px 24px", textAlign: "center" }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, marginBottom: 12 }}>Filonuzu net bir şekilde görmeye hazır mısınız?</h2>
          <p style={{ fontSize: 14, color: slate, marginBottom: 24 }}>14 gün ücretsiz deneme. Kredi kartı gerekmez.</p>
          <button style={{ padding: "14px 36px", background: teal, color: navy, fontSize: 15, fontWeight: 700, border: "none", borderRadius: 6, cursor: "pointer" }}>Ücretsiz Denemeyi Başlat</button>
        </div>
      </section>
